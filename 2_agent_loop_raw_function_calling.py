...
def get_prod_price(product: str) -> float:
    ...
    print(f" >> Executing get_prod_price(product='{product}')")
    prices = {
        "laptop": 1299.99, 
        "headphones": 149.95, 
        "keyboard": 89.50}
...
def apply_discount(price: float, discount_tier: str) -> float:
    ...
    print (f" >> Eexecuting apply_discount(price={price}, discount_tier='{discount_tier})")
    discount_map = {
        "bronze": 5,
        "silver": 15,
        "gold": 25}
...
# Manual JSON schema to show what Langchain is doing 
tools_for_llm = [{
    "type": "function",
    "function": {
        "name": "get_prod_price",
        "description": "Look up the price of a product in tehe catalog",
        "parameters": {
            "type": "object",
            "properties": {
                "product": {
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply a discount to a price and return the final price. Available tiers: bronze, silver, gold", 
            "parameters": {
                "type": "object",
                "properties": {
